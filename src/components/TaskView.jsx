...
export default function TaskView({ task, dispatch }) {
    ...
    return (
        <div className='w-100'>
            <div className={`d-flex ps-3 pe-2 align-items-center py-2 justify-content-between ${hoverItem ? 'hover-bg-light' : ''}`} onMouseEnter={() => setHoverItem(true)} onMouseLeave={() => setHoverItem(false)}>
                ...
                <div className="d-flex gap-1">                
                    <button className="btn p-0 focus:shadow-none focus:outline-none border-0" onClick={() => {setOpenUpdateTask(true)}}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#9CA3AF" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="hover-stroke-light">
                    ...
                    <button className="btn p-0 focus:shadow-none focus:outline-none border-0" onClick={handleDelete}>
